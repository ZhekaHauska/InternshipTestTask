...
def sobel_unet(
    ...
    # line2 for Sobel operator
    line2_x = Conv2D(1, (3, 3), padding="same", use_bias=False, activation=lambda t: K.square(t),
                     kernel_initializer=initializers.sobel_x_init, trainable=False)(inputs)
    line2_y = Conv2D(1, (3, 3), padding="same", use_bias=False, activation=lambda t: K.square(t),
                     kernel_initializer=initializers.sobel_y_init, trainable=False)(inputs)
    line2 = Add()([line2_x, line2_y])
    line2 = Lambda(lambda t: K.sqrt(t))(line2)
    line2 = conv2d_block(
            inputs=line2,
            filters=filters,
            use_batch_norm=use_batch_norm,
    ...
    outputs = concatenate([line1, line2])
    outputs = Conv2D(num_classes, (1, 1), activation=output_activation)(outputs)
